...
<video width="720" height="480" autoplay loop muted>
  <source src="/assets/images/BreakableObjectPlatformPhysicsReframe.mov" type="video/mov">
</video>
<video width="720" height="480" autoplay loop muted>
  <source src="/assets/images/ParkourWDashReframe.mov" type="video/mov">
</video>
<video width="720" height="480" autoplay loop muted>
  <source src="/assets/images/BreakableObjectWallrun1Reframe.mov" type="video/mov">
</video>
## UI
