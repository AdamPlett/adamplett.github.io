...
<video width="720" height="480" autoplay loop muted>
  <source src="/assets/images/BreakableObjectPlatformPhysicsReframe.mp4" type="video/mp4">
</video>
<video width="720" height="480" autoplay loop muted>
  <source src="/assets/images/ParkourWDashReframe.mp4" type="video/mp4">
</video>
<video width="720" height="480" autoplay loop muted>
  <source src="/assets/images/BreakableObjectWallrun1Reframe.mp4" type="video/mp4">
</video>
## UI
